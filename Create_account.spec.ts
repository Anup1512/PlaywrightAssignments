   ...
   await expect(page).toHaveURL('https://orgfarm-503c21e0be-dev-ed.develop.lightning.force.com/lightning/page/home')
     console.log(page.url())
       ...
       //  await page.waitForTimeout(120000)
         ...
         await expect(page.locator("//div//h2[text()='New Account']")).toBeVisible({ timeout: 120000 })

         //unable to fill account name as element is not getting displayed
         await page.locator('#input-646').fill("ABS consultants")
         //await page.getByLabel("Account Name").fill("ABS consultants");
